...
func file_ionscale_v1_acl_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_ionscale_v1_acl_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_ionscale_v1_acl_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_ionscale_v1_acl_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_ionscale_v1_acl_proto_msgTypes[3].Exporter = func(v any, i int) any {
